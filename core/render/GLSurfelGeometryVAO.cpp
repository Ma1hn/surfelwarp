...
void surfelwarp::buildFusionMapVAO(
    const surfelwarp::GLSurfelGeometryVBO& geometryVBO, GLuint& fusion_map_vao)
{
    // Create and bind vao
...
void surfelwarp::buildSolverMapVAO(
    const surfelwarp::GLSurfelGeometryVBO& geometryVBO, GLuint& solver_map_vao)
{
    // Create and bind vao
...
void surfelwarp::buildReferenceGeometryVAO(
    const GLSurfelGeometryVBO& geometryVBO, GLuint& reference_geometry_vao)
{
    // Create and bind vao
...
void surfelwarp::buildLiveGeometryVAO(
    const GLSurfelGeometryVBO& geometryVBO, GLuint& live_geometry_vbo)
{
